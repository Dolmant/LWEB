...
(rum/defc Template [appInstance css jsmap]
  ...
  [:html.loading#html
   [:head
    ...
    cssTemplate
    [:style
     {:dangerouslySetInnerHTML {:__html "html.loading #loading {background-image:url('/assets/images/MV_AniBlack.gif');background-size:10rem 10rem;background-position:center;background-repeat:no-repeat;height:100vh;width:100vw;}html {min-height:100%;}html.loading {overflow:hidden;height:100vh}"}}]
