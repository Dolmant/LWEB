...
var len__5143__auto___12658 = arguments.length;
var i__5144__auto___12659 = (0);
while(true){
if((i__5144__auto___12659 < len__5143__auto___12658)){
args__5146__auto__.push((arguments[i__5144__auto___12659]));

var G__12660 = (i__5144__auto___12659 + (1));
i__5144__auto___12659 = G__12660;
continue;
} else {
}
break;
...
return shadow.util.go_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__5147__auto__);
});
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq12652){
var self__5129__auto__ = this;
return self__5129__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12652));
});
...
var len__5143__auto___12680 = arguments.length;
var i__5144__auto___12681 = (0);
while(true){
if((i__5144__auto___12681 < len__5143__auto___12680)){
args_arr__5162__auto__.push((arguments[i__5144__auto___12681]));

var G__12682 = (i__5144__auto___12681 + (1));
i__5144__auto___12681 = G__12682;
continue;
} else {
}
break;
...
var argseq__5163__auto__ = (new cljs.core.IndexedSeq(args_arr__5162__auto__.slice((6)),(0),null));
return shadow.util.log.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),argseq__5163__auto__);
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq12669){
var G__12670 = cljs.core.first(seq12669);
var seq12669__$1 = cljs.core.next(seq12669);
var G__12671 = cljs.core.first(seq12669__$1);
var seq12669__$2 = cljs.core.next(seq12669__$1);
var G__12672 = cljs.core.first(seq12669__$2);
var seq12669__$3 = cljs.core.next(seq12669__$2);
var G__12673 = cljs.core.first(seq12669__$3);
var seq12669__$4 = cljs.core.next(seq12669__$3);
var G__12674 = cljs.core.first(seq12669__$4);
var seq12669__$5 = cljs.core.next(seq12669__$4);
var G__12675 = cljs.core.first(seq12669__$5);
var seq12669__$6 = cljs.core.next(seq12669__$5);
var self__5128__auto__ = this;
return self__5128__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12670,G__12671,G__12672,G__12673,G__12674,G__12675,seq12669__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__12683){
var vec__12684 = p__12683;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12684,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12684,(1),null);
