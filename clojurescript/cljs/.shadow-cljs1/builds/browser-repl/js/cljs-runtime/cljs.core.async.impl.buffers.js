...
var self__ = this;
var this$ = this;
var n__5010__auto__ = self__.length;
var x = (0);
while(true){
if((x < n__5010__auto__)){
var v_8118 = this$.pop();
if((keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(v_8118) : keep_QMARK_.call(null,v_8118))){
this$.unshift(v_8118);
} else {
}
...
cljs.core.async.impl.buffers.PromiseBuffer.cljs$lang$ctorPrWriter = (function (this__4742__auto__,writer__4743__auto__,opt__4744__auto__){
return cljs.core._write(writer__4743__auto__,"cljs.core.async.impl.buffers/PromiseBuffer");
});
