...
var i_8315 = (0);
while(true){
if((i_8315 < arr.length)){
(arr[i_8315] = null);

var G__8327 = (i_8315 + (1));
i_8315 = G__8327;
continue;
} else {
}
...
var i_8382 = (self__.level + (1));
while(true){
if((i_8382 <= (new_level + (1)))){
(update[i_8382] = self__.header);
...
var i_8387 = (0);
while(true){
if((i_8387 <= self__.level)){
var links_8388 = (update[i_8387]).forward;
if((x__$1 === (((i_8387 < links_8388.length))?(links_8388[i_8387]):null))){
(links_8388[i_8387] = (x__$1.forward[i_8387]));

var G__8389 = (i_8387 + (1));
i_8387 = G__8389;
continue;
} else {
var G__8390 = (i_8387 + (1));
i_8387 = G__8390;
continue;
}
} else {
...
if(!((nx == null))){
var G__8396 = nx;
var G__8397 = (level__$1 - (1));
x = G__8396;
level__$1 = G__8397;
continue;
} else {
var G__8398 = x;
var G__8399 = (level__$1 - (1));
x = G__8398;
level__$1 = G__8399;
continue;
}
...
var G__8411 = nx;
var G__8412 = (level__$1 - (1));
x = G__8411;
level__$1 = G__8412;
continue;
} else {
var G__8414 = x;
var G__8415 = (level__$1 - (1));
x = G__8414;
level__$1 = G__8415;
continue;
}
...
var or__4453__auto__ = (cljs.core.truth_((function (){var and__4442__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__4453__auto__,timeout,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__4453__auto__,timeout,me))
,msecs);
