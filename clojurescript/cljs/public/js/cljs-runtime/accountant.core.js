...
var G__5781 = history;
var G__5782 = goog.history.EventType.NAVIGATE;
var G__5783 = ((function (G__5781,G__5782){
return (function (e){
var token = e.token;
...
;
return goog.events.listen(G__5781,G__5782,G__5783);
});
/**
...
if(cljs.core.truth_((function (){var and__4442__auto__ = node;
...
var navigation_link_QMARK_ = (function (){var and__4442__auto__ = href;
if(cljs.core.truth_(and__4442__auto__)){
var and__4442__auto____$1 = attrs;
...
var G__5787 = document;
var G__5788 = "click";
var G__5789 = ((function (G__5787,G__5788){
return (function (e){
var target = e.target;
var button = e.button;
...
if(cljs.core.truth_((function (){var and__4442__auto__ = cljs.core.not(any_key);
if(and__4442__auto__){
var and__4442__auto____$1 = (function (){var fexpr__5794 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__5794.cljs$core$IFn$_invoke$arity$1 ? fexpr__5794.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__5794.call(null,link_target));
})();
if(cljs.core.truth_(and__4442__auto____$1)){
var and__4442__auto____$2 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(button,(0));
if(and__4442__auto____$2){
var and__4442__auto____$3 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(host,current_host);
if(and__4442__auto____$3){
var and__4442__auto____$4 = ((cljs.core.not(port)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2([cljs.core.str.cljs$core$IFn$_invoke$arity$1(port)].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_port)].join(''))));
if(and__4442__auto____$4){
...
return and__4442__auto____$4;
}
} else {
return and__4442__auto____$3;
}
} else {
...
var G__5796 = history;
var G__5799 = (new goog.history.Event(path,true));
return goog.events.dispatchEvent(G__5796,G__5799);
} else {
return null;
}
} else {
...
;
return goog.events.listen(G__5787,G__5788,G__5789);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__5816){
var map__5819 = p__5816;
var map__5819__$1 = ((((!((map__5819 == null)))?(((((map__5819.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5819.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5819):map__5819);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5819__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5819__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5819__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5824_SHARP_){
return cljs.core.name(p1__5824_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__5829_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__5843 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__5843) : accountant.core.nav_handler.call(null,G__5843));
} else {
