...
(def button (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "Button")))
...
(def form-control (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "FormControl")))
(def flat-button (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "FlatButton")))
(def hidden (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "Hidden")))
(def form-helper-text (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "FormHelperText")))
...
(def grid (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "Grid")))
...
(def input-label (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "InputLabel")))
...
(def select (cljs-react-material-ui.core/adapt-rum-class (aget js/MaterialUI "Select")))
